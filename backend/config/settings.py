...
PASSWORD_RESET_RESEND_COOLDOWN_SECONDS = config('PASSWORD_RESET_RESEND_COOLDOWN_SECONDS', default=60, cast=int)

# Google OAuth
GOOGLE_OAUTH_CLIENT_ID = config('GOOGLE_OAUTH_CLIENT_ID', default='')
GOOGLE_OAUTH_CLIENT_SECRET = config('GOOGLE_OAUTH_CLIENT_SECRET', default='')
GOOGLE_OAUTH_REDIRECT_URI = config('GOOGLE_OAUTH_REDIRECT_URI', default='http://localhost:8000/api/v1/auth/google/callback/')
FRONTEND_OAUTH_REDIRECT_URL = config('FRONTEND_OAUTH_REDIRECT_URL', default='http://localhost:3000/oauth/callback')
